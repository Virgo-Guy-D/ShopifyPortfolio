...
const testimonials = [
  ...
  },
  {
    ...
    avatar: 'MC',
    rating: 5,
    text: 'The subscription system Arthur built for us has been a game-changer. We went from manual order management to a fully automated system that handles 15,000+ subscribers. Customer retention improved dramatically.',
  ...
  },
  {
    ...
    avatar: 'ER',
    rating: 5,
    text: 'Working with him on our headless commerce project was incredible. The 3D product visualization and AR features have set us apart from competitors. Site speed is lightning fast and customers love the experience.',
  ...
  },
  {
    ...
    avatar: 'DP',
    rating: 5,
    text: 'Arthur built our entire multi-vendor marketplace from scratch. The vendor dashboards, commission management, and automated payouts work flawlessly. We now process 500+ transactions daily without a hitch.',
